...
use loadr_core::protocol::{
    GrpcBinaryField, GrpcProtobufFieldCheck, GrpcRequest, PreparedRequest, ProtocolHandler,
...
async fn grpc_binary_field_uses_raw_bytes() {
    ...
    let request = grpc_request(
        ...
        GrpcRequest {
            ...
            method: "UnaryEcho".into(),
            message: Some(Arc::new(
                serde_json::json!({"message": "raw", "payload": ""}),
            )),
...
async fn grpc_binary_field_rejects_non_bytes_target() {
    ...
    let request = grpc_request(
        ...
        GrpcRequest {
            ...
            service: "loadr.test.Echo".into(),
            method: "UnaryEcho".into(),
            message: Some(Arc::new(serde_json::json!({"message": ""}))),
            binary_fields: vec![GrpcBinaryField {
                message_index: 0,
